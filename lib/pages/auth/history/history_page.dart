                    ...
                    : historyController.showedList.length == 0
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              // List<String> nama = historyController.showedList[index]['id'].toString().split('-');
                              //   print("Nama ${nama}");
                              print("Index: $index name: ${historyController.showedList.length}");
                              ...
                              if (index == historyController.showedList.length) {
                                          ...
                                          child: Transform.scale(
                                            ...
                                            child: SizedBox(
                                              ...
                                              child: LoadingIndicator(
                                                ...
                                                strokeWidth: 5.0,
                                                colors: [
                                                  Color.fromARGB(255, 217, 142, 255),
                                                ],
                                ...
                                print("berapa banyak history dari controller: ${historyController.showedList.length} apa saja history: ${historyController.showedList[index]['id']}");
