...
import 'package:okejek_flutter/controller/auth/okerental/map_destination_rent_controller.dart';
...
class MapDestinationRentalPage extends StatelessWidget {
  final Completer<GoogleMapController> _controller = Completer();

  final TextEditingController destTextController = TextEditingController();
  final MapDestinationRentController destinationController = Get.put(MapDestinationRentController());
  final OkeRentController orderRentController = Get.find();
                    ...
                    child: GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          confirmButton(orderRentController, destinationController),
                        ],
                      ),
                    ),
                  ),
  ...
  showModalLokasi(MapDestinationRentController destinationController, PanelController pc) {
  ...
  Widget confirmButton(OkeRentController orderRentController, MapDestinationRentController destinationController) {
    return Obx(
      () => GestureDetector(
        onTap: () {
          destinationController.destLocation.value.isEmpty
              ? print('do nothing')
              : confirm(orderRentController, destinationController);
        },
  ...
  void confirm(OkeRentController orderRentController, MapDestinationRentController destinationController) {
