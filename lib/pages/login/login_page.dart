...
import 'package:okejek_flutter/pages/forgot_password_page.dart';
import 'package:okejek_flutter/pages/login/login_error_widget.dart';
                    ...
                    children: [
                      ...
                      Obx(() => loginController.isLoginFailure.value
                          ? Padding(
                              ...
                              child: LoginErrorWidget(loginController: loginController),
                            )
                          : Container()),
                    ],
                  ),
