...
class OkeCourierMap extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      print( "di oke courier map ${cp.latitude} ${cp.longitude} ${okeCourierController.originLat.value} ${okeCourierController.originLng.value}");
        ...
        GoogleMap(
          ...
          markers: Set<Marker>.of([
            ...
            Marker(
              ...
              position: LatLng(
                okeCourierController.destinationLat.value,
                okeCourierController.destinationLng.value,
              ),
