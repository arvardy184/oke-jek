...
class DestSearchHeaderModal extends StatelessWidget {
    ...
    return Column(
      ...
      children: [
        ...
        Material(
          child: InkWell(
            onTap: () {
              print("Pilih lokasi dari map");
              Get.back();
              okeRideController.isPickingfromMap.value = true;
              okeRideController.destinationMapPick.value = true;
              pc.close();
             print("isPickingfromMap setelah diubah: ${okeRideController.isPickingfromMap.value}");
            },
            child: Container(
  ...
  validate(OkeCarController controller, String value) {
