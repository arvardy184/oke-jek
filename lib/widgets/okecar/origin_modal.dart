...
import 'package:okejek_flutter/widgets/okecar/origin_search_header_modal.dart';
import 'package:okejek_flutter/widgets/okecar/origin_search_result_modal.dart';
...
class OriginModal extends StatelessWidget {
  ...
  final OkeCarController okeRideController = Get.find();
  ...
  Future<dynamic> showPickUpModal(OkeCarController controller) {
