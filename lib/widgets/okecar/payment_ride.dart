...
class PaymentSectionRide extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    OkeCarController okeRideController = Get.find();
  ...
  static void showPromoCodeDialog(BuildContext context, OkeCarController okeRideController) {
  ...
  Future<dynamic> dialog(OkeCarController okeRideController, BuildContext context) {
    return Get.dialog(
      AlertDialog(
        title: Text(
          'Masukkan Kode Kupon',
